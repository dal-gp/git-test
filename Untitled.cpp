...
//  func
//
//  Created by Dal Garbuja Pun on 15/06/2014.
//  Copyright (c) 2014 Dal. All rights reserved.
//
...
int main(int argc, const char * argv[])
{
    ...
    cout << "Line 8: After funTwo: num1 = " << num2 << ", num2 = " << num2 << ", and ch = " << ch << endl;
